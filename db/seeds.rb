...
codetombomb = User.create(username: "codetombomb", email: "codetombomb@gmail.com", password: "codetombomb", password_confirmation: "codetombomb", admin: false)
eri_is_cool = User.create({username: 'eriiscool', email: 'eriiscool@gmail.com', password: "eriiscool", password_confirmation: "eriiscool", admin: true})
